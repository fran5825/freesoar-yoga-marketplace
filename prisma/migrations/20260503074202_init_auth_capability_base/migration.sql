-- CreateEnum
CREATE TYPE "TeacherProfileStatus" AS ENUM ('draft', 'submitted', 'approved', 'rejected', 'suspended');

-- CreateEnum
CREATE TYPE "OrganizationType" AS ENUM ('company', 'company_club', 'community', 'family_group', 'other');
