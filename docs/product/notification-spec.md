...
`docs/superpowers/plans/2026-07-27-notification-plan.md`、`2026-07-28-class-session-cancellation-plan.md`、`2026-07-28-demand-request-cancellation-plan.md` 已把本文件描述的 notification 資料模型與**大部分** event 落地，但實際落地方式跟本文件原本規劃的「V1 以 email 為主」有一個重要落差，記錄如下：
